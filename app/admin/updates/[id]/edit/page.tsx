  ...
  const fetchUpdate = async () => {
    try {
      ...
      setForm({
        ...
        featured_video_url: update.featured_video_url || '',
        featured_file_url: update.featured_file_url || '',
        media_type: update.media_type,
        category: update.category,
        tags: update.tags || [],
        seo_title: update.seo_title || '',
        seo_description: update.seo_description || '',
        seo_keywords: update.seo_keywords || '',
        published: update.published,
        published_at: update.published_at ? update.published_at.slice(0, 16) : '',
      })
    } catch (err) {
    ...
    return (
      <SiteShell>
        <div className="container admin-update-form">
          <div className="admin-loading">Loading update...</div>
        </div>
      </SiteShell>
    )
  }
    ...
    <SiteShell>
      <div className="container admin-update-form">
        <div className="admin-form-header">
          <h1>Edit Update</h1>
          <p className="admin-subtitle">Modify campaign update</p>
        </div>
