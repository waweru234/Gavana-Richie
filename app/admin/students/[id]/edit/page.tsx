  ...
  const fetchStudent = async () => {
    try {
      ...
      setForm({
        ...
        sponsoredBy: student.sponsored_by || '',
        sponsoredDate: student.sponsored_date || '',
        sponsoredQuote: student.sponsored_quote || '',
        published: student.published,
        sort_order: student.sort_order || 0,
      })
    } catch (err) {
    ...
    return (
      <SiteShell>
        <div className="container admin-student-form">
          <div className="admin-loading">Loading student...</div>
        </div>
      </SiteShell>
    )
  }
    ...
    <SiteShell>
      <div className="container admin-student-form">
        <div className="admin-form-header">
          <h1>Edit Student</h1>
          <p className="admin-subtitle">Modify student details</p>
        </div>
